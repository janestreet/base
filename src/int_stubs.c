...
// internally this is implemented by caml_dummy_int32_of_string_unboxed
CAMLprim int32_t caml_dummy_int32_of_string_unboxed(value s) {
  return (int32_t)parse_intnat(s, 32, INT32_ERRMSG);
}

// only used for public release;
// internally this is implemented by caml_dummy_int64_of_string_unboxed
...
// only used for public release;
// internally this is implemented by caml_dummy_nativeint_of_string_unboxed
