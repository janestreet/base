...
module Without_comparator      = Base_map_intf.Without_comparator
module With_comparator         = Base_map_intf.With_comparator
module With_first_class_module = Base_map_intf.With_first_class_module
