...
type 'a t = 'a list [@@deriving compare, hash, sexp]
...
val permute : ?random_state:Base_random.State.t -> 'a t -> 'a t
...
val random_element     : ?random_state:Base_random.State.t -> 'a t -> 'a option
val random_element_exn : ?random_state:Base_random.State.t -> 'a t -> 'a
