...
val rev_mapi : ('a t[@kind ka]) -> f:(int -> 'a -> 'b) -> ('b t[@kind kb])

val filter_map
  :  ('a t[@kind ka])
  -> f:('a -> ('b Option0.t[@kind kb]))
  -> ('b t[@kind kb])

val filter_mapi
  :  ('a t[@kind ka])
  -> f:(int -> 'a -> ('b Option0.t[@kind kb]))
  -> ('b t[@kind kb])

val concat_map : ('a t[@kind ka]) -> f:('a -> ('b t[@kind kb])) -> ('b t[@kind kb])
