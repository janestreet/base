...
let%template[@mode local] compare a _ = unreachable_code a
let equal a _ = unreachable_code a
let%template[@mode local] equal a _ = unreachable_code a
let sexp_of_t = unreachable_code
let%template[@alloc stack] sexp_of_t = unreachable_code_local
