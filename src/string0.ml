...
let[@inline] get_utf_8_uchar t ~byte_pos = get_utf_8_uchar t byte_pos
...
let[@inline] get_utf_16be_uchar t ~byte_pos = get_utf_16be_uchar t byte_pos
...
let[@inline] get_utf_16le_uchar t ~byte_pos = get_utf_16le_uchar t byte_pos
...
let[@inline] get_utf_32le_uchar t ~byte_pos =
  get_utf_32_uchar t ~byte_pos ~get_int32:unsafe_get_int32_le
;;

let[@inline] get_utf_32be_uchar t ~byte_pos =
