...
let%test _ = equal (of_int (Pervasives.compare 0 1)) Less
let%test _ = equal (of_int (Pervasives.compare 1 1)) Equal
let%test _ = equal (of_int (Pervasives.compare 1 0)) Greater
