...
module%test [@name "test_pred_exn"] _ = struct
...
module%test [@name "test_int_is_scalar"] _ = struct
...
module%test [@name "test_is_char"] _ = struct
...
module%test [@name "test_equal"] _ = struct
...
module%test [@name "test_compare"] _ = struct
