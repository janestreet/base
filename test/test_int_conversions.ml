...
let%test_module "conversions" =
  (module struct
    ...
    let test_conversion (type a) (type b) loc ma mb
          a_to_b_or_error
          a_to_b_trunc
          b_to_a_trunc
      =
    ...
    let test loc ma mb
          (a_to_b_trunc, a_to_b_or_error)
          (b_to_a_trunc, b_to_a_or_error)
      =
    ...
    module Int32     = struct include Int32     let module_name = "Int32"     end
    module Int64     = struct include Int64     let module_name = "Int64"     end
    ...
    let%expect_test "int <-> int32" =
      test [%here] (module Int) (module Int32)
    ...
    let%expect_test "int <-> int64" =
      test [%here] (module Int) (module Int64)
    ...
    let%expect_test "int <-> nativeint" =
      test [%here] (module Int) (module Nativeint)
    ...
    let%expect_test "int32 <-> int64" =
      test [%here] (module Int32) (module Int64)
    ...
    let%expect_test "int32 <-> nativeint" =
      test [%here] (module Int32) (module Nativeint)
    ...
    let%expect_test "int64 <-> nativeint" =
      test [%here] (module Int64) (module Nativeint)
